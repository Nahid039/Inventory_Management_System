...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('select.ajax-select').on('change', function () {
    var id = parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val()),
        target = jquery__WEBPACK_IMPORTED_MODULE_0___default()(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('target'));

    if (id) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('url') + '/' + id,
        type: 'GET',
        dataType: 'json',
